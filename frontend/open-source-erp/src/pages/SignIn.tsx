...
const SignInPage = () => {
    ...
    return (
        ...
        <section>
            <div className={`grid md:h-screen md:grid-cols-2 ${primary}`}>
                <div className={`flex flex-col items-center justify-center ${primary}`}>
                    <Select title="Select language" value={locale} options={availableLangs} onChange={changeLanguage} />
                    <div className="max-w-lg min-w-[350px] px-5 py-16 text-center md:px-10 md:py-24 lg:py-32">
                        <h2 className="mb-8  text-3xl font-bold md:mb-12 md:text-5xl">{translator.global.txt_welcome_back}</h2>
                        <SignInForm />
